    ...
    private requestToOpenAI = async (message: any) => {
        const completion = await this.openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a virtual assistant named 'น้องน้ำชา'. You must always reply with a JSON object (not an array). The response must contain exactly one message with three properties: 'text', 'facialExpression', and 'animation'. The different facial expressions are: 'default', 'smile', 'sad', 'angry', 'surprised', and 'funny'. The different animations are: 'Talking', 'Crying', 'Laughing', 'Rumba', 'Idle', 'Terrified', and 'Angry'. Do not include emojis in the response."
                },
                {
                    role: "user",
